 ...
 *
 */
public class PurchaseLedgerFrame extends javax.swing.JFrame {

    /**
     * Creates new form RegisterFrame
     */
    Object columns[] = {"Id", "Purchase No","Purchase Date", "Recipt No", "Customer", "Vat", "Total Amount", "Paid", "Payable"};
    ...
    public void fillTable(List<TransactionDTO> ledgers) {
        ...
        purchaseTable.getColumnModel().getColumn(0).setMinWidth(0);
        purchaseTable.getColumnModel().getColumn(0).setMaxWidth(0);
        purchaseTable.getColumnModel().getColumn(1).setWidth(200);
        purchaseTable.getColumnModel().getColumn(1).setMinWidth(200);
        purchaseTable.getColumnModel().getColumn(1).setMaxWidth(200);
        purchaseTable.getColumnModel().getColumn(4).setWidth(150);
        purchaseTable.getColumnModel().getColumn(4).setMinWidth(150);
        purchaseTable.getColumnModel().getColumn(4).setMaxWidth(150);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PurchaseLedgerFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PurchaseLedgerFrame().setVisible(true);
            }
        });
    }
